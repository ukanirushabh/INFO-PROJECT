      ...
      <div className='container-fluid '>
        <div className='row'>
          ...
          <div className='values col-sm-8'>
            ...
            <p>
              <strong>VISION:</strong> The vision of the HouseHop project is to create a platform where users can easily discover and book vacation homes or short-term rentals from anywhere in the world. HouseHop aims to provide a seamless experience for customers to find and reserve their ideal accommodations through a fully integrated online system. Users can set up an account on the website to explore a wide range of available properties, view details about each home, and make reservations conveniently from any location globally. The platform will offer comprehensive information about various types of vacation homes, ensuring that customers can find the perfect house for their getaway
            </p>
          </div>
        </div>
      </div>
